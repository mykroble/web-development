<?php
    ...
    $valid_status = ['Married', 'Not Married', 'other'];
    if ($marital_status === 'select from options' || !in_array($marital_status, $valid_status)) {
      $marital_status = null; // Invalid gender
    }
      ...
      if (empty($fname) || empty($lname) || empty($mname) || empty($gender) || !$birthdate || empty($phone_number) || empty($street) || empty($barangay) || empty($city) || empty($province) || empty($marital_status) || empty($occupation)) {
      } else {
        $sql="INSERT INTO `patient` (fname,mname,lname,gender,birthdate,phone_number,street,barangay,province,marital_status,occupation,city) 
        VALUES('$fname','$mname','$lname','$gender','$birthdate','$phone_number','$street','$barangay','$province','$marital_status','$occupation','$city')";
...
<ul class="nav flex-column" style="margin-top: 140px;">
  ...
  <li class="nav-item">
    <a class="nav-link active" href="createPatient.php"><img src="person_add_24dp_FILL0_wght400_GRAD0_opsz24.png" alt="" width="70px"></a>
  </li>
</ul></div>
...
<h1 style="padding: 50px;">Create Patient</h1>
...
<form method="post" class="needs-validation" novalidate>
  ...
  <div class="col-md-4 mb-3">
    ...
    <input type="text" class="form-control" required id="validationCustom01" placeholder="Enter First Name Here" name="fname">
    </div>
    <div class="col-md-4 mb-3">
    <label for="validationCustom02">Middle Name</label>
    <input type="text" class="form-control" required id="validationCustom02" placeholder="Enter Middle Name Here" name="mname">
    </div>
    <div class="col-md-4 mb-3">
    <label for="validationCustom03">Last Name</label>
    <input type="text" class="form-control" required id="validationCustom03" placeholder="Enter Last Name Here" name="lname">
  </div>
  </div>
...
<div class="form-row">
    ...
    <input class="form-control" required id="validationCustom05" type="number" min="1" max="31" placeholder="DD" name="day"> 
    </div>
    <div class="col-md-4 mb-3">
    <label for="validationCustom06" style="color:white;">.</label>
    <input class="form-control" required id="validationCustom06" type="number" min="1" max="12" placeholder="MM" name="month">
    </div>
    <div class="col-md-4 mb-3">
    <label for="validationCustom07" style="color:white;">.</label>
    <input class="form-control" required id="validationCustom07" type="number" min="1" max="9999" placeholder="YYYY" name="year">
    </div>
</div>
</div>
<div class="col-md-4 mb-3">
    <label for="validationCustom08">Phone Number</label>
    <input type="text" class="form-control" required id="validationCustom08" id="formGroupExampleInput" placeholder="Enter Phone Number Here" maxlength="11" name="contactNumber">
</div>
</div>
...
<div class="col-md-3 mb-3">
    ...
    <input type="text" class="form-control" required id="validationCustom09" id="formGroupExampleInput" placeholder="Enter Street Name Here" name="street">
  </div>
  <div class="col-md-3 mb-3">
    <label for="validationCustom10">Barangay</label>
    <input type="text" class="form-control" required id="validationCustom10" id="formGroupExampleInput" placeholder="Enter Barangay Name Here" name="barangay">
  </div>
  <div class="col-md-3 mb-3">
    <label for="validationCustom11">City</label>
    <input type="text" class="form-control" required id="validationCustom11" id="formGroupExampleInput" placeholder="Enter City Name Here" name="city">
  </div>
  <div class="col-md-3 mb-3">
    <label for="validationCustom12">Province</label>
    <input type="text" class="form-control" required id="validationCustom12" id="formGroupExampleInput" placeholder="Enter Province Name Here" name="province">
  </div>
  </div>
  ...
  <div class="form-group">
    ...
    <input type="text" required id="validationCustom13" class="form-control" id="formGroupExampleInput" placeholder="Enter Occupation Here" name="occupation">
  </div>
